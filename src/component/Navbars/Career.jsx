       ...
       <>
        <div className={CareerCSS.body}>
            ...
            <div className={CareerCSS.content}>
               ...
               <p className={CareerCSS.p}>Please be informed that at any given point in time, you can only have one "Active" application.</p>
               ...
               <div className={CareerCSS.jobdescribe}>
                ...
                <p className={CareerCSS.jobdesc}><b>Educational Quatification:</b>Must be currently pursuing a Bachelor of Technology (B.Tech) or equivalent in Computer Science, Information Technology, or a related field.</p>

               </div>
            </div>
            <div className={CareerCSS.container}>
                <img className={CareerCSS.hockmad} src={Hockmad} alt="" />
