    ...
    return (
        <div className={FooterCSS.body}>
           ...
           <h1 className={FooterCSS.head}>Useful Links</h1>
             <Link className={FooterCSS.link} to="/terms"><i class='bx bxs-square'></i> Terms and Conditions</Link>
                <Link className={FooterCSS.link} to="/privacy"> <i class='bx bxs-square'></i> Privacy and Policy</Link>
                <Link className={FooterCSS.link} to="/cancel"><i class='bx bxs-square'></i> Cancellations and Refunds</Link>
                <Link  className={FooterCSS.link} to="/contact"> <i class='bx bxs-square'></i> Contact US</Link>
            </div>
